...
class NeutrinoFactory(icetray.I3ConditionalModule):
    def __init__(self, context):
        ...
        self.AddParameter('z_range',
                          ...
                          [-500, 500])
        self.AddParameter('shift_vertex_distance',
        ...
        self.AddParameter('max_vertex_distance',
                          ...
                          None)
        self.AddParameter('max_track_distance',
                          ...
                          None)
        self.AddParameter('convex_hull_distance_function',
